...
const layer = createLayer("lore", () => {
    ...
    const loreData: Infobox<InfoboxOptions>[] = [
        ...
        createInfobox(
            () =>
                ({
                    visibility: computed(() => showIf(light.order.value === 1)),
                    color: "#fff5c9",
                    title: "Speed is Key",
                    display: jsx(() => (
                        <>
                            Heads! Great, now we get another tool to mess with the universe! Let
                            there be light!
                            <br />
                            <br />
                            No, I'm not planning to add rave lights to everything, what do you think
                            I am, only a thousand years old?
                            <br />
                            <br />
                            Well yes I do have crazy lights now, but I'm not planning to string them
                            around all willy-nilly, cmon! I'm just going to *tastefully* put them
                            around molecules that should emit light!
                            <br />
                            <br />
                            What? No, you cannot make a bunch of rave lights in my universe, it's MY
                            universe, not yours. Damn, you're more obnoxious than your boss! I'm the
                            one in charge here, and I say no rave lights!
                            <br />
                            <br />
                            Well I don't care if you think otherwise, I'm going to use the light for
                            something actually important, and you can't stop me!
                            <br />
                        </>
                    )),
                    style: {
        ...
        createInfobox(
            () =>
                ({
                    visibility: computed(() => showIf(sound.order.value === 1)),
                    color: "#ddcfff",
                    title: "Do I Even Have Ears?",
                    display: jsx(() => (
                        <>
                            Tails! Great, now we get another tool to mess with the universe! Time
                            for a party!
                            <br />
                            <br />
                            No, screw responsibility, I'm going to blast some great music! I don't
                            care if music doesn't exist here yet, I'll invent it myself!
                            <br />
                            <br />
                            Well yes I do have something great, but I'm not planning to tastefully
                            put them around molecules that should emit sound, cmon! I'm just going
                            to string them around all willy-nilly and blast music!
                            <br />
                            <br />
                            What? No, you cannot stop me from having a universe party, it's MY
                            universe, not yours. Damn, you're more obnoxious than your boss! I'm the
                            one in charge here, and I say it's party time!
                            <br />
                            <br />
                            Well I don't care if you think otherwise, I'm going to use the sound for
                            something actually fun, and you can't stop me!
                            <br />
                        </>
                    )),
                    style: {
